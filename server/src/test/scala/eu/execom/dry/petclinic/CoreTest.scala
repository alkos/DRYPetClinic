...
abstract class CoreTest extends AbstractFabutTest with IFabutRepositoryTest {
  ...
  override def getEntityTypes: java.util.List[Class[_]] = classOf[User] :: classOf[Client] :: classOf[Role] :: classOf[Permission] :: classOf[owner] :: classOf[PetType] :: classOf[Pet] :: classOf[PetHistory] :: classOf[VetSpecialty] :: classOf[Vet] :: classOf[VetSpecialties] :: classOf[Visit] :: Nil
  ...
  override def findById(entityClass: Class[_], id: AnyRef): AnyRef =
    ...
    else if (entityClass == classOf[Client]) clientDao.findById(id.asInstanceOf[Int]).orNull
  ...
  override def findAll(entityClass: Class[_]): java.util.List[_] =
    ...
    else if (entityClass == classOf[Client]) clientDao.findAll
